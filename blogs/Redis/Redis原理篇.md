...
![redis1653984583289](../blog_img/redis1653984583289.png)

那么Redis将在底层创建两个SDS，其中一个是包含“name”的SDS，另一个是包含“虎哥”的SDS。

Redis是C语言实现的，其中SDS是一个结构体，源码如下：

![redis1653984624671](../blog_img/redis1653984624671.png)

例如，一个包含字符串“name”的sds结构如下：

![redis1653984648404](../blog_img/redis1653984648404.png)
...
![redis1653984838306](../blog_img/redis1653984838306.png)
...
![redis1653984923322](../blog_img/redis1653984923322.png)

其中的encoding包含三种模式，表示存储的整数大小不同：

![redis1653984942385](../blog_img/redis1653984942385.png)
...
![redis1653985197214](../blog_img/redis1653985197214.png)
...
![redis1653985276621](../blog_img/redis1653985276621.png)

源码如下：

![redis1653985304075](../blog_img/redis1653985304075.png)

![redis1653985327653](../blog_img/redis1653985327653.png)
...
![redis1653985396560](../blog_img/redis1653985396560.png)
...
![redis1653985586543](../blog_img/redis1653985586543.png)
...
![redis1653986282879](../blog_img/redis1653986282879.png)

![redis1653986217182](../blog_img/redis1653986217182.png)
...
![redis1653987159575](../blog_img/redis1653987159575.png)

![redis1653987172764](../blog_img/redis1653987172764.png)

![redis1653987202522](../blog_img/redis1653987202522.png)
...
![redis1653987240622](../blog_img/redis1653987240622.png)
...
![redis1653987313461](../blog_img/redis1653987313461.png)
...
![redis1653987342550](../blog_img/redis1653987342550.png)
...
![redis1653987388177](../blog_img/redis1653987388177.png)

结构如下：

​	![redis1653987454403](../blog_img/redis1653987454403.png)
...
![redis1653992121692](../blog_img/redis1653992121692.png)

![redis1653992172526](../blog_img/redis1653992172526.png)
...
![redis1653992238097](../blog_img/redis1653992238097.png)

![redis1653992299740](../blog_img/redis1653992299740.png)
...
![redis1653992339937](../blog_img/redis1653992339937.png)

zset集合如下：

![redis1653992360355](../blog_img/redis1653992360355.png)
...
![redis1653844970346](../blog_img/redis1653844970346.png)

用户的应用，比如redis，mysql等其实是没有办法去执行访问我们操作系统的硬件的，所以我们可以通过发行版的这个壳子去访问内核，再通过内核去访问计算机硬件

![redis1653845147190](../blog_img/redis1653845147190.png)

计算机硬件包括，如cpu，内存，网卡等等，内核（通过寻址空间）可以操作硬件的，但是内核需要不同设备的驱动，有了这些驱动之后，内核就可以去对计算机硬件去进行 内存管理，文件系统的管理，进程的管理等等

![redis1653896065386](../blog_img/redis1653896065386.png)
...
![redis1653896377259](../blog_img/redis1653896377259.png)
...
![redis1653896687354](../blog_img/redis1653896687354.png)
...
![redis1653897115346](../blog_img/redis1653897115346.png)
...
![redis1653897270074](../blog_img/redis1653897270074.png)
...
![redis1653897490116](../blog_img/redis1653897490116.png)
...
![redis1653898691736](../blog_img/redis1653898691736.png)
...
![redis1653900022580](../blog_img/redis1653900022580.png)
...
![redis1653900721427](../blog_img/redis1653900721427.png)
...
![redis1653902845082](../blog_img/redis1653902845082.png)
...
![redis1653911776583](../blog_img/redis1653911776583.png)
...
![redis1653911877542](../blog_img/redis1653911877542.png)

#### 3.0.2 对比

最后用一幅图，来说明他们之间的区别

![redis1653912219712](../blog_img/redis1653912219712.png)
...
![redis1653982278727](../blog_img/redis1653982278727.png)
...
![redis1653982993020](../blog_img/redis1653982993020.png)
...
![redis1653983341150](../blog_img/redis1653983341150.png)
...
![redis1653983366243](../blog_img/redis1653983366243.png)

可以发现，当key的TTL到期以后，再次访问name返回的是nil，说明这个key已经不存在了，对应的内存也得到释放。从而起到内存回收的目的。

Redis本身是一个典型的key-value内存存储数据库，因此所有的key、value都保存在之前学习过的Dict结构中。不过在其database结构体中，有两个Dict：一个用来记录key-value；另一个用来记录key-TTL。

![redis1653983423128](../blog_img/redis1653983423128.png)



![redis1653983606531](../blog_img/redis1653983606531.png)
...
![redis1653983652865](../blog_img/redis1653983652865.png)
...
![redis1653983978671](../blog_img/redis1653983978671.png)
...
![redis1653984029506](../blog_img/redis1653984029506.png)
...
![redis1653984085095](../blog_img/redis1653984085095.png)
